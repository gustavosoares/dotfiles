...
class Connection extends dbgp_1.DbgpConnection {
    ...
    sendRunCommand() {
        return __awaiter(this, void 0, void 0, function* () {
            return new StatusResponse(yield this._enqueueCommand('run'), this);
        });
    }
    /** sends a step_into command */
    sendStepIntoCommand() {
        return __awaiter(this, void 0, void 0, function* () {
            return new StatusResponse(yield this._enqueueCommand('step_into'), this);
        });
    }
    /** sends a step_over command */
    sendStepOverCommand() {
        return __awaiter(this, void 0, void 0, function* () {
            return new StatusResponse(yield this._enqueueCommand('step_over'), this);
        });
    }
    /** sends a step_out command */
    sendStepOutCommand() {
        return __awaiter(this, void 0, void 0, function* () {
            return new StatusResponse(yield this._enqueueCommand('step_out'), this);
        });
    }
