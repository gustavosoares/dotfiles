...
class PhpDebugSession extends vscode.DebugSession {
    ...
    setBreakPointsRequest(response, args) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const fileUri = paths_1.convertClientPathToDebugger(args.source.path, this._args.localSourceRoot, this._args.serverSourceRoot);
                ...
                if (connections.length === 0) {
                    ...
                    yield Promise.all(connections.map((connection, connectionIndex) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield Promise.all(breakpoints
                            .filter(breakpoint => breakpoint instanceof xdebug.LineBreakpoint && paths_1.isSameUri(fileUri, breakpoint.fileUri))
            ...
            try {
                ...
                if (stack.length === 0 && status && status.exception) {
                    ...
                    if (urlObject.protocol === 'dbgp:') {
                        ...
                        const filePath = paths_1.convertDebuggerPathToClient(urlObject, this._args.localSourceRoot, this._args.serverSourceRoot);
