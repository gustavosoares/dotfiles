...
var sessionsFolder = path.resolve(__dirname, "sessions/");
var sessionFilePath = path.resolve(sessionsFolder, "PSES-VSCode-" + process.env.VSCODE_PID);
...
function readSessionFile() {
    var fileContents = fs.readFileSync(sessionFilePath, "utf-8");
